    ...
    <footer className="bg-black border-t border-white/10 py-12 md:py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <div>
            <span className="font-display text-3xl text-white tracking-wider block mb-4">
              ZLE
            </span>
            <p className="text-white/60 text-sm font-sans leading-relaxed">
              Český underground skate brand.<br />
              Raw × Crew × Real Life.
            </p>
          </div>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              <Link href="/shop" className="text-white/60 hover:text-white text-sm transition-colors" data-testid="link-footer-shop">
                SHOP
              </Link>
              <Link href="/story" className="text-white/60 hover:text-white text-sm transition-colors" data-testid="link-footer-story">
                STORY
              </Link>
              <Link href="/crew" className="text-white/60 hover:text-white text-sm transition-colors" data-testid="link-footer-crew">
                CREW
              </Link>
