        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-8 opacity-0 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              <div className="p-6 md:p-8 border border-white/20 bg-white/5">
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="w-12 h-12 border border-white/30 flex items-center justify-center group-hover:bg-white group-hover:text-black transition-colors">
              ...
              <div className="p-6 md:p-8 border border-white/20 bg-white/5">
                ...
                <Button
                  asChild
                  variant="outline"
                  className="font-heading text-sm tracking-wider border-white/30 text-white hover:bg-white hover:text-black"
                >
